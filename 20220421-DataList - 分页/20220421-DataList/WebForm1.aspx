...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="tbx_pagenum" runat="server" Height="17px" style="text-align: center" Width="28px">1</asp:TextBox>
&nbsp;
            <asp:Button ID="btn_go" runat="server" OnClick="btn_go_Click" Text="GO" Width="52px" />
        </div>
    </form>
</body>
</html>
