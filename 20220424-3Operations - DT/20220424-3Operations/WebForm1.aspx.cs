...
namespace _20220424_3Operations
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        private void LoadGridView()
        {
            ...
            //
            dt.PrimaryKey = new DataColumn[] { dt.Columns["officeid"] };
        ...
        //
        private int DoUpdateOffice2(OfficeClass oc)
        {
            if (oc != null)
            {
                DataTable dt = DT;
                DataRow dr = dt.Rows.Find(oc.OfficeID);
                dr.BeginEdit();
                //反射
                Type t= oc.GetType();
                ...
                /*dr["officeid"] = oc.OfficeID;
                dr["officename"] = oc.OfficeName;
                dr["schoolid"] = oc.SchoolID;
                dr["authorizedid"] = oc.AutorizedID;*/
                dr.EndEdit();
                string connstring = ConfigurationManager.ConnectionStrings["ScoreDBConn"].ConnectionString;
                SqlConnection sconn = new SqlConnection(connstring);
        ...
        private int DoUpdateOffice(OfficeClass oc)
        {
            ...
            SqlCommand scd = new SqlCommand(updatestring, sconn);
            scd.Parameters.AddWithValue("officeid", oc.OfficeID);
            scd.Parameters.AddWithValue("officename", oc.OfficeName);
            scd.Parameters.AddWithValue("schoolid", oc.SchoolID);
        ...
        protected void gv_Office_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                oc.Authorizedid = ((DropDownList)this.gv_Office.Rows[e.RowIndex].FindControl("ddl_gvstatus")).SelectedValue;
                //
